...
${dbpass}          pass
${dbhost}          host
${dbport}         27017   # default port for MySQL protocol
...
Execute SQL Script - Insert Data person table
    ...
    Comment           ${output} =    Execute SQL Script    ${CURDIR}/../Resources/commonmysql.robot
    ${output}=        Execute SQL Script    ${CURDIR}/../resources/commonmysql.robot
    Log               ${output}
    Should Be Equal As Strings    ${output}    None
